...
function YPostMenu({postId,postUsername,postUserId}) {
    ...
    //open alert when post is deleted
    ...
    const handleDelete = (e) => {
            DataBase.collection("posts").doc(postId).delete().then(() => {
    ...
    <div className={classes.root}>
      ...
      <AlertDialog text={"Post deleted successfully!"} openAlert={openAlertDelete} changeAlert={al=>{setOpenAlertDelete(al)}}/>
              ...
              <Paper className={classes.paper}>
                <ClickAwayListener onClickAway={handleClose}>
                  <MenuList autoFocusItem={open} id="menu-list-grow" onKeyDown={handleListKeyDown}>
                    ...
                    <MenuItem className={classes.menuElement} onClick={handleDelete}>Delete</MenuItem>
                  </MenuList>
                </ClickAwayListener>
              </Paper>
            </Grow>
